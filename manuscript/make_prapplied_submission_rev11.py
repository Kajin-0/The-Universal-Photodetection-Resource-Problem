#!/usr/bin/env python3
"""Generate the Physical Review Applied submission copy from Rev11."""
from pathlib import Path
SRC = Path('event_resource_theorem_rev11.tex')
OUT = Path('event_resource_theorem_rev11_prapplied.tex')
s = SRC.read_text(encoding='utf-8')
assert r'\author{Anonymous}' in s
assert r'\affiliation{Anonymous}' in s
assert r'\input{section_practical_grounding_rev11}' in s
...
% author directed and verified its output. See submission/AI_DISCLOSURE_DRAFT_REV11.md.
