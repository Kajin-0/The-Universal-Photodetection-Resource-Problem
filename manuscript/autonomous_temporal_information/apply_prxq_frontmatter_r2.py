#!/usr/bin/env python3
"""Generate the PRX Quantum R2 manuscript from the audited M2R2 body."""
...
BASE = HERE / "autonomous_temporal_resource_law_m2r2.tex"
ABSTRACT = HERE / "sections" / "prxq_abstract_r2.tex"
INTRO = HERE / "sections" / "prxq_introduction_r2.tex"
...
OUT = HERE / "autonomous_temporal_resource_law_prxq_r2.tex"
...
def main() -> None:
    ...
    front = (
        maketitle
        + "\n\\input{sections/prxq_introduction_r2.tex}\n"
