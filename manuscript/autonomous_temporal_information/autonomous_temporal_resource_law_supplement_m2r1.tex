...
This Supplemental Material gives self-contained proof cores for the resource statements used in the main text. We work with finite-dimensional clock and signal Hilbert spaces, as appropriate to the finite-internal-system formulation studied here; infinite-dimensional extensions require separate domain and closed-range hypotheses and are not claimed. The order follows the physical hierarchy: finite-radius survival, rank-changing boundary synthesis, the arbitrary-support mixed bridge, the multi-gap shared-Hessian law, and finally the exact qutrit common-record accessibility benchmark. Standard ingredients---numerical-radius inequalities, PSD-cone second-order geometry, shorted operators, and multiparameter Fisher bounds---are used as mathematical infrastructure rather than novelty claims \cite{BhatiaJain2023,Shapiro1997,BonnansCominettiShapiro1999,AndersonTrapp1975,BraunsteinCaves1994,GillMassar2000}.

\section{Finite-radius survival}
\input{proofs/finite_radius_survival_proofs.tex}

\section{Rank-changing boundary synthesis and autonomous action}
\input{proofs/boundary_and_autonomous_action_proofs.tex}
\input{proofs/boundary_qfi_nonregular_scope.tex}

\section{Arbitrary coherent support}
\input{proofs/noncommuting_mixed_bridge_proof_r1.tex}

\section{Multi-gap shared-Hessian action}
\input{proofs/multigap_action_sum_proof_r1.tex}

\section{Exact common-record accessibility benchmark}
\input{proofs/shared_kernel_qutrit_benchmark.tex}
\input{proofs/wp15_exact_common_record_qutrit.tex}
