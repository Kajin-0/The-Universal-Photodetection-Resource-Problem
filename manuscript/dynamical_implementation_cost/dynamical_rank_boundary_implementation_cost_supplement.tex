...
Let $\Omega(\bm\theta)=U(\bm\theta)\Omegazero U(\bm\theta)^\dagger$, with $U(0)=I$ and $\partial_jU(0)=-iK_j$, $K_j=K_j^\dagger$. Write the one-coordinate expansion
\begin{equation}
...
\end{equation}
This argument also shows why the identity is independent of the second derivative of the unitary curve.
...
\section{Repaired infinite-dimensional energy-conserving construction}
...
\section{Trace-norm $C^2$ control of the direct-sum family}
