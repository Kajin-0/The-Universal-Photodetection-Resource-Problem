...
A unitary implementation may use an arbitrary ancillary/controller Hilbert space $E$ and a global baseline $\Omegazero$ with $\Tr_E\Omegazero=\rhozero$. For tangent generators $K_j=K_j^\dagger$ of the global unitary family at the origin, define the state-weighted quadratic coupling cost
\begin{equation}
...
\end{equation}
This remains true for separable infinite-dimensional targets with unbounded occupied target-energy support and for stationary excess curvature in target-energy sectors unoccupied at baseline.
\end{theorem}
