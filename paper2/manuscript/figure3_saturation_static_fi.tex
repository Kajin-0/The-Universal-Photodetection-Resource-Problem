...
\node[anchor=south east,font=\scriptsize,align=right] at (axis cs:2.88,0.31) {same curve for every recovery law\\with mean $m$};
\node[anchor=north west,font=\scriptsize] at (axis cs:1.04,0.363) {count maximum};
\end{axis}
\end{tikzpicture}
\end{minipage}\hfill
